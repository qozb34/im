...
bot = TeleBot(token="6731112584:AAH0L-yq_aNsUId4P5uIrndhGEqNCUIyZ1E",num_threads=45,threaded=True,skip_pending=True,parse_mode='html', disable_web_page_preview=True) # توكن بوت الرشق الاساسي هنا
if not db.get('accounts'):
    db.set('accounts', [])
    pass

admin = 6070114166 #الادمن
